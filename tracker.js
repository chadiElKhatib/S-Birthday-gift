(() => {
  ...
  const pageName =
    document.body.dataset.page || "ukendt";
  ...
  const device =
    /iPhone|iPad|Android|Mobi/i.test(
      navigator.userAgent
    )
      ? "📱 Mobil"
      : "💻 Computer";
  ...
  function getBotInformation() {
    ...
    const foundBot = botNames.find(name =>
  ...
  function buildTrackingData(
    ...
    return {
      ...
      possibleBot:
        botInformation.possibleBot,

      botName:
        botInformation.botName,
